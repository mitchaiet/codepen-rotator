...
const Hours = ({ hours, size }) => {
  ...
  return /*#__PURE__*/(
    React.createElement("g", { className: "hand" }, /*#__PURE__*/
...
class SVGatch extends Component {
  ...
  render() {
    ...
    */
    return /*#__PURE__*/(
      React.createElement("svg", { width: size + margin * 2, height: size + margin * 2 }, /*#__PURE__*/
      React.createElement("g", { transform: translate }, /*#__PURE__*/
      React.createElement("g", { transform: center }, /*#__PURE__*/
...
ReactDOM.render( /*#__PURE__*/React.createElement(SVGatch, null), document.getElementById('root'));